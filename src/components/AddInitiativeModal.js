...
export default function AddInitiativeModal({ type, organizerId, organizerName, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/organizer/initiatives', {
        method: 'POST',
        ...
        body: JSON.stringify({
          ...
          type: type, // Keep the full type name (campaigns, seminars, workshops)
